...
test: check-docker
	...
	@echo "  $(YELLOW)Contracts API =>$(NC)  http://localhost:8081/swagger-ui/index.html"
	@echo "  $(YELLOW)Notifications =>$(NC)  http://localhost:8082"
	@echo "  $(YELLOW)User Service  =>$(NC)  http://localhost:8083/swagger-ui/index.html"
	@echo "  $(YELLOW)Client Svc    =>$(NC)  http://localhost:8084/swagger-ui/index.html"
	...
	@echo ""
	@echo "  $(YELLOW)Contracts API JSON docs =>$(NC)  http://localhost:8081/v3/api-docs"
	@echo "  $(YELLOW)User Service JSON docs  =>$(NC)  http://localhost:8083/v3/api-docs"
	@echo "  $(YELLOW)Client Service JSON docs =>$(NC)  http://localhost:8084/v3/api-docs"
	@echo ""
	@echo ""
