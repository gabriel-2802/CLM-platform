...
export async function getContractRows(): Promise<Row[]> {
  ...
  return contracts.map((contract: any) => {
    ...
    return {
      ...
      panaLa: toISODate(contract.terminationDate ?? contract.contractEndDate),
      ...
      contractEndDate: toISODate(contract.contractEndDate),
      terminationDate: toISODate(contract.terminationDate),
